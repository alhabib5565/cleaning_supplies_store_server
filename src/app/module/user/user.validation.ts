...
const createUserValidationSchema = z.object({
    ...
    role: z.enum(Object.keys(USER_ROLE) as [string, ...string[]], { message: 'Invalid role' }).default('Customer'),
    status: z.enum(Object.keys(USER_STATUS) as [string, ...string[]], { message: 'Invalid status' }).default('Active'),
